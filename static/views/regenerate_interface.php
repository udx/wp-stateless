...
<div class="wrap" ng-app="wpStatelessApp" ng-controller="wpStatelessTools" ng-init="init()">
  ...
  <form id="go" ng-submit="processStart($event)">
    ...
    <div class="option">
      <label>
        <input type="radio" name="action" value="regenerate_images" ng-model="action" />
    ...
    <div class="option">
      <label>
        <input type="radio" name="action" value="sync_non_images" ng-model="action" />
    ...
    <div class="buttons">
      <button ng-if="action == 'regenerate_images' && progresses.images || action == 'sync_non_images' && progresses.other" ng-disabled="isRunning || isLoading" type="submit" name="method" value="continue" class="button-primary"><?php _e( 'Continue last process' ); ?></button>
      <button ng-disabled="isRunning || isLoading" type="submit" name="method" value="start" class="button-primary"><?php _e( 'Start Process (may take a while)' ); ?></button>
