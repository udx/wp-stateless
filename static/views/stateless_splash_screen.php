                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <div class="wpStateLess-welcome-text">
                            ...
                            <a class="btn btn-rounded btn-green" href="<?php echo ud_get_stateless_media()->get('page_url.stateless_setup');?>&step=google-login">Get Started Now</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="wpStateLess-s-plan wpStateLess-free-plan">
                            ...
                            <div class="text-center">
                                <a href="<?php echo admin_url('upload.php?page=stateless-setup&amp;step=google-login');?>" class="btn btn-green">Get Started Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
