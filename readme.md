...
define( 'WP_STATELESS_MEDIA_KEY_FILE_PATH', '/var/www/wp-content/keys/application-name-service-id.json' );
...
```json
{
  "wp_stateless_media": {
    ...
    "mode": "cdn",
    "key_file_path": "/var/www/wp-content/keys/application-name-service-id.json",
  }
}
```
...
wp option update sm_key_file_path /var/www/wp-content/keys/some-key.json
