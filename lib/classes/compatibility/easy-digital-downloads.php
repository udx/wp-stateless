...
/**
 * Compatibility Plugin Name: Easy Digital Downloads
 * Compatibility Plugin URI: https://wordpress.org/plugins/easy-digital-downloads/
 *
...
namespace wpCloud\StatelessMedia {
  ...
  if (!class_exists('wpCloud\StatelessMedia\EDDDownloadMethod')) {
    ...
    class EDDDownloadMethod extends Compatibility {
