 ...
 *  </code>
 */
class Google_Service_AdExchangeBuyerII_Resource_AccountsFilterSetsNonBillableWinningBids extends Google_Service_Resource
{
  /**
   * List all reasons for which winning bids were not billable, with the number of
   * bids not billed for each reason.
   * (nonBillableWinningBids.listAccountsFilterSetsNonBillableWinningBids)
   *
   ...
   * call to the accounts.filterSets.nonBillableWinningBids.list method.
   * @return Google_Service_AdExchangeBuyerII_ListNonBillableWinningBidsResponse
   */
  public function listAccountsFilterSetsNonBillableWinningBids($accountId, $filterSetId, $optParams = array())
  {
