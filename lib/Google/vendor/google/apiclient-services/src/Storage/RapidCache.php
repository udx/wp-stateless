...
class RapidCache extends \Google\Model
{
  /**
  ...
  public $bucket;
  /**
   * The type of Rapid Cache this represents. Valid values include: "rapid-
   * cache" and "rapid-cache-ultra".
   *
   * @var string
   */
  public $cacheType;
...
class_alias(RapidCache::class, 'Google_Service_Storage_RapidCache');
